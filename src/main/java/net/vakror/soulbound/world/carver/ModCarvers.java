package net.vakror.soulbound.world.carver;
...
public class ModCarvers {
    public static final ResourceKey<ConfiguredWorldCarver<?>> HUGE_CAVE = ResourceKey.create(Registries.CONFIGURED_CARVER, new ResourceLocation(SoulboundMod.MOD_ID, "huge_cave"));
