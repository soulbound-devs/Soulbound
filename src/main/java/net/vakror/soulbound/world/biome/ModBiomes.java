...
import net.vakror.soulbound.mixin.OverworldBiomesInvoker;
...
public class ModBiomes {
    public static Biome corrupted_cave(HolderGetter<PlacedFeature> holderGetter, HolderGetter<ConfiguredWorldCarver<?>> p_256212_) {
        ...
        generationSettings.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, ResourceKey.create(Registries.PLACED_FEATURE, new ResourceLocation(SoulboundMod.MOD_ID, "corrupted_tree_placed")));
