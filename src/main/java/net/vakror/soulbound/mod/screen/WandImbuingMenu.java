...
import net.vakror.soulbound.mod.blocks.entity.custom.WandImbuingTableBlockEntity;
import net.vakror.soulbound.mod.screen.slot.ModResultSlot;
import net.vakror.soulbound.mod.screen.slot.ModSealSlot;
import net.vakror.soulbound.mod.screen.slot.ModWandSlot;
