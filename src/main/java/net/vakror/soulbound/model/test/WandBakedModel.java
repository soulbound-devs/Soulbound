		...
		for(int e = 0; e <= elements.size() - 1; e ++){
			...
			switch(element.getUsage()){
				case POSITION :
					...
					break;
				case COLOR :
					consumer.put(e, WandBakedModel.COLOR_R, WandBakedModel.COLOR_G, WandBakedModel.COLOR_B, 1.0f);
					break;
				case NORMAL :
					consumer.put(e, (float) orientation.getStepX(), (float) orientation.getStepY(), (float) orientation.getStepZ(), 0.0f);
					break;
				case UV :
