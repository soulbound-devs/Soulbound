...
public class DungeonProcessorRules {
    ...
    public static final List<ProcessorRule> DEEP_BLOOD = new ImmutableList.Builder<ProcessorRule>()
    ...
    public static final List<ProcessorRule> OLD_RUINS = new ImmutableList.Builder<ProcessorRule>()
    ...
    public static final List<ProcessorRule> AMETHYST_VOID = new ImmutableList.Builder<ProcessorRule>()
    ...
    public static final List<ProcessorRule> GILDED_HOARD = new ImmutableList.Builder<ProcessorRule>()
    ...
    public static final List<ProcessorRule> ANCIENT_ENDER = new ImmutableList.Builder<ProcessorRule>()
