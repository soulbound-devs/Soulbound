...
public class ModStructures {
    public static final DeferredRegister<StructureType<?>> STRUCTURE_TYPE_REGISTRY = DeferredRegister.create(Registries.STRUCTURE_TYPE, SoulboundMod.MOD_ID);
    ...
    public static void bootstrapSets(BootstapContext<StructureSet> bootstrapContext) {
        ...
        bootstrapContext.register(ResourceKey.create(Registries.STRUCTURE_SET, new ResourceLocation(SoulboundMod.MOD_ID, "dungeon")), new StructureSet(holdergetter.getOrThrow(ResourceKey.create(Registries.STRUCTURE, new ResourceLocation(SoulboundMod.MOD_ID, "dungeon"))), new RandomSpreadStructurePlacement(32, 8, RandomSpreadType.LINEAR, 45234535)));
    }

    public static void bootstrap(BootstapContext<Structure> bootstrapContext) {
        bootstrapContext.register(ResourceKey.create(Registries.STRUCTURE, new ResourceLocation(SoulboundMod.MOD_ID, "dungeon")), new DungeonStructure(structure()));
    }
