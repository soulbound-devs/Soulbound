...
public class SealTooltips {
    ...
    public static SealTooltip HASTE = new SealTooltipBuilder()
            ...
            .build();
    public static SealTooltip HASTE_TIER_2 = new SealTooltipBuilder()
            .addPart(SealTooltipComponent.amplifying())
            .addPart(new SealTooltipComponentBuilder()
                    .addPartWithNewline("")
                    ...
                    .addPartWithNewline("Max Tier: 3")
                    .addPartWithNewline("When On Wand: ")
                    .addPartWithNewline("   • Mining Speed +16", GREEN).build())
            .build();
    public static SealTooltip HASTE_TIER_3 = new SealTooltipBuilder()
            .addPart(SealTooltipComponent.amplifying())
            .addPart(new SealTooltipComponentBuilder()
                    .addPartWithNewline("")
