...
public class SoulHudOverlay {
    ...
    public static final IGuiOverlay HUD_SOUL = ((gui, graphics, partialTick, width, height) -> {
        ...
        graphics.drawString(Minecraft.getInstance().font, (int) soul + "/" +(int)  maxSoul,x - 145 - soulWidth, y - 80, toColorInt(255, 255, 255, 255), false);
        graphics.drawString(Minecraft.getInstance().font, (int) darkSoul + "/" + (int) maxDarkSoul,x - 98 - darkSoulWidth, y - 80, toColorInt(255, 255, 255, 255), false);
